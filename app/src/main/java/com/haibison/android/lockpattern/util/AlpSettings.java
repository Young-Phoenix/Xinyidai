...
public class AlpSettings {
    ...
    public static final String genPreferenceFilename() {
        return String.format("%s_%s", com.haibison.android.lockpattern.util.Alp.LIB_NAME, com.haibison.android.lockpattern.util.Alp.UID);
    ...
    public static final String genDatabaseFilename(String name) {
        return String.format("%s_%s_%s", com.haibison.android.lockpattern.util.Alp.LIB_NAME, com.haibison.android.lockpattern.util.Alp.UID, name);
    }// genDatabaseFilename()
