...
package github.phoenix.library.swipeback;
...
public class SwipeBackLayout extends FrameLayout {
     ...
     * callback's
     * {@link github.phoenix.library.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link github.phoenix.library.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
